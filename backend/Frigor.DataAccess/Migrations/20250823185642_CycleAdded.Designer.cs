...
namespace Frigor.DataAccess.Migrations
{
    ...
    [Migration("20250823185642_CycleAdded")]
    partial class CycleAdded
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Frigor.Common.Entities.Cycle", b =>
                {
            ...
            modelBuilder.Entity("Frigor.Common.Entities.Trigger", b =>
                {
                    b.HasOne("Frigor.Common.Entities.Cycle", "Cycle")
                        .WithMany()
                        .HasForeignKey("CycleUuid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
